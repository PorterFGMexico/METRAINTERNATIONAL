...
<header id="header" class="header">
  ...
  <div class="header-nav">
    <div class="header-nav-wrapper navbar-scrolltofixed bg-white">
      <div class="container">
        <nav id="menuzord-right" class="menuzord default"> <a class="menuzord-brand pull-left flip xs-pull-center mt-20" href="../index.php"> <img src="../images/logo-wide.png" alt=""> </a><div class="logo-wrapperx"><a class="menuzord-brand" href="../h/c01e.php" title= "English Version"><img src="../images/english.png" class="logoryrx" title="English Version"></a></div>
          <ul class="menuzord-menu">
            <li class="active"><a href="../index.php">Home</a></li>
            <li><a href="a01.php">Acerca de Nosotros</a> </li>
            <li><a href="s01.php">Servicios</span></a>
              <ul class="dropdown"><li><a href="s01.php">Venta de Diesel en Centro de Distribucion</a></li>
                <li><a href="s02.php">Suministro de Diesel a Tanque de Autoconsumo</a></li>
                <li><a href="s03.php">Tanques de Autoconsumo, Venta o Comodato</a></li>
                <li><a href="s04.php">Crédito y Financiamiento</a></li>
                <li><a href="s05.php">Software de control de flotillas</a></li>
                <li><a href="s06.php">Mantenimiento y Laboratorio Móvil</a></li>
                  </ul>
                  </li>
            <li><a href="p01.php">Productos</a></li>
              <li><a href="g01.php">Empresas del Grupo</a></li>
              <li><a href="c01.php">Contacto</a></li>
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/corporate/contacto.jpg">
      <div class="container pt-100 pb-50">
        ...
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">Contacto</h3>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase font-28 mt-0"><span class="text-theme-colored">Cotiza</span> Aqui</h2>
            </div>
          </div>
        </div>
        <div class="section-content">          
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input id="form_bussines" name="form_bussines" class="form-control" type="text" placeholder="Empresa" required="">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input id="form_name" name="form_name" class="form-control" type="text" placeholder="Nombre de Contacto" required="">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_position" name="form_position" class="form-control required" type="text" placeholder="Cargo">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_phone" name="form_phone" class="form-control" type="text" placeholder="Telefono" required="">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_email" name="form_email" class="form-control required email" type="email" placeholder="Correo">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_subject" name="form_subject" class="form-control required" type="text" placeholder="Asunto">
                    </div>
                  </div>
                   
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_tank" name="form_tank" class="form-control required" type="text" placeholder="¿Requiere Tanque Autoconsumo?">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_units" name="form_units" class="form-control required" type="text" placeholder="Numero de Camiones">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_liters" name="form_liters" class="form-control required" type="text" placeholder="Litros Consumidos por Dia">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <input id="form_liters" name="form_litersm" class="form-control required" type="text" placeholder="Litros Consumidos por Mes">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <textarea id="form_message" name="form_message" class="form-control required" rows="5" placeholder="Mensaje"></textarea>
                </div>
              ...
              <div>
                ...
                <div style="width: 300px; height: 60px; border-style: none;
                  ...
                  <button data-loading-text="Por favor espere..." class="btn btn-colored btn-rounded btn-theme-colored pl-30 pr-30" type="submit">Envie su Mensaje</button>
                </div>
              </form>
