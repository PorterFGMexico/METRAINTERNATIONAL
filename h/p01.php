  ...
  <header id="header" class="header">
    ...
    <div class="header-nav">
      <div class="header-nav-wrapper navbar-scrolltofixed bg-white">
        <div class="container">
          <nav id="menuzord-right" class="menuzord default"> <a class="menuzord-brand pull-left flip xs-pull-center mt-20" href="../index.php"> <img src="../images/logo-wide.png" alt=""> </a><div class="logo-wrapperx"><a class="menuzord-brand" href="../h/p01e.php" title= "English Version"><img src="../images/english.png" class="logoryrx" title="English Version"></a></div>
            <ul class="menuzord-menu">
              ...
              <li><a href="../h/s01.php">Servicios</span></a>
                <ul class="dropdown">
                  ...
                  <li><a href="../h/s03.php">Tanques de Autoconsumo, Venta o Comodato</a></li>
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/product/p01.jpg">
      <div class="container pt-100 pb-50"> 
        ...
        <div class="section-content pt-100">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Diesel Ultra Bajo en Azufre</h3>
      ...
      <div class="row mtli-row-clearfix">
        <div class="col-sm-6 col-md-8 col-lg-8">
          <div class="project mb-30">
            ...
            <div class="project-details p-15 pt-10 pb-10">
              <h5 class="sub-title font-14 font-weight-500 mb-5">Nuestro Producto Estrella</h5>
              <h4 class="title font-weight-700 text-uppercase mt-0">Diésel Ultra Bajo en Azufre</h4>
            </div>
          </div>
          <div class="event-details">
            <p class="mb-20 mt-20">En METRA Hidrocarburos ofrecemos mediante el apoyo de nuestra cadena de logística especializada llevar a cabo la distribución y reparto de combustibles a través de la importación de los mismos. Analizamos constantemente las variaciones de precios por región geográfica de nuestros clientes con la finalidad de mantener el abasto constante y las mejores condiciones de oferta del mercado.</p>
            <div class="pull-left flip mr-15"> <img alt="" src="../images\product\p03.jpg"> </div>
            <div>
              <p class="font-14 text-black-light"><em>Nuestro producto es el Diésel Ultra Bajo en Azufre (UBA). Este es un tipo de diésel con menos de 15 ppm de azufre, lo que representa alrededor de 97% menos de azufre en comparación al diésel común D2 (500 ppm).</em></p>
              <p class="mt-10">Nuestras alianzas estratégicas nos permiten distribuir este producto en regiones donde aún no se encuentra disponible en las cantidades que nos sean requeridas por los clientes y a precios mucho más bajos que los del mercado, esto se traduce en menor costo, mayor autonomía, reducción de los contaminantes emitidos y aumento en la vida útil de sus vehículos.</p>
            </div>
            <p class="mt-20">Este diésel da cumplimiento cabalmente a los requerimientos de la NORMA Oficial Mexicana de Emergencia NOM-EM-005-CRE-2015.</p>
            </div>
            </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="sidebar sidebar-right mt-sm-30">
            <div class="widget">
              <h5 class="widget-title line-bottom">Descarga los datos técnicos</h5>
              <div class="brochured">
                <ul class="list">
                  <li><a href="docs/ht.pdf"><i class="fa fa-file-pdf-o"></i>Hoja Técnica de Especificaciones</a></li>
                  <li><a href="docs/cer.pdf"><i class="fa fa-file-pdf-o"></i>Certificado de análisis</a></li>
                </ul>
              </div>
            </div>
             <div class="widget">
              <h5 class="widget-title line-bottom">Nuestros Productos</h5>
              <div class="owl-carousel-1col" data-dots="true">
                <div class="item">
                  <img src="../images/product/gs03.jpg" alt="">
                  <h4 class="title text-white">Combustible</h4>
                  <p>Le ofrecemos la mejor calidad en Diésel Ultra Bajo en Azufre.</p>
                </div>
                <div class="item">
                  <img src="../images/product/gs02.jpg" alt="">
                  <h4 class="title text-white">Tanques</h4>
                  <p>Le ofrecemos la posibilidad de suministrar directamente a sus tanques de combustible.</p>
                </div>
                <div class="item">
                  <img src="../images/product/gs01.jpg" alt="">
                  <h4 class="title text-white">Centro de Abasto</h4>
                  <p>Ofrecemos la venta directa de combustible en nuestro centro de abasto de combustible.</p>
                </div>
              </div>
            </div>
            <div class="widget">
              <h5 class="widget-title line-bottom">Haga lo correcto</h5>
              <ul class="list list-divider list-border">
                <li><i class="fa fa-check-square-o mr-10 text-black-light"></i> Mejore su rendimiento</li>
                <li><i class="fa fa-check-square-o mr-10 text-black-light"></i> Expanda la vida útil de sus unidades</li>
                <li><i class="fa fa-check-square-o mr-10 text-black-light"></i> Trate mejor a sus vehículos</li>
                <li><i class="fa fa-check-square-o mr-10 text-black-light"></i> Reduzca la contaminación</a></li>
                <li><i class="fa fa-check-square-o mr-10 text-black-light"></i> Ahorre dinero</li>
              </ul>
            </div>
          </div>
        </div>
