...
<header id="header" class="header">
          ...
          <ul class="menuzord-menu">
            ...
            <li><a href="s01.php">Servicios</span></a>
              <ul class="dropdown"><li><a href="s01.php">Venta de Diesel en Centro de Distribucion</a></li>
                ...
                <li><a href="s03.php">Tanques de Autoconsumo en Comodato [Por ahora no disponible]</a></li>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/services/ss01.jpg">
      <div class="container pt-100 pb-50">
        <!-- Section Content -->
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Venta de Diesel en Centro de Distribucion</h3>
              <ul class="breadcrumb white">
                <li><a href="../index.php">Home</a></li>
                <li class="active">Metra Hidrocarburos</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              <img src="../images/services/ssh01.jpg" alt="">
              <h4 class="line-bottom text-uppercase mt-30 mb-20">Descripcion del Servicio</h4>
              <p style="text-align: justify;">Le ofrecemos con evidencias la mejor calidad de combustible Diesel y bajo en azufre, cuidando el medio ambiente y rendimiento de sus unidades. Manejamos precios competitivos para que tenga un ahorro inmediato en el consumo diario de sus unidades, siempre por debajo de precio de bomba de PEMEX.</p>
              <p style="text-align: justify;">Asegurando ahorro considerable en el consumo de combustible con beneficio directo e inmediato para su empresa.</p>
            </div>
          </div>
            ...
            <div class="sidebar sidebar-left mt-sm-30 ml-30 ml-sm-0">
              <div class="widget">
                <div class="services-list">
                  <ul class="list mt-0">
                    <li class="active"><a href="s01.php">Venta de Diesel en Centro de Distribucion</a></li>
                    <li><a href="s02.php">Suministro de Diesel a Tanque de Consumo</a></li>
                    <li><a href="s03.php">Tanques de Consumo en Comodato [Por ahora no disponible]</a></li>
                    <li><a href="s04.php">Credito y Financiamiento</a></li>
                    <li><a href="s05.php">Software de Control de Flotillas</a></li>
                    <li><a href="s06.php">Mantenimiento y Laboratorio Móvil</a></li>
                  </ul>
                </div>
