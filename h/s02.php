    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/services/ss02.jpg">
      <div class="container pt-100 pb-50"> 
        ...
        <div class="section-content pt-100">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Suministro de Diesel a Tanque de Autoconsumo</h3>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service"> <img src="../images/services/ssh02.jpg" alt="">
              ...
              <p style="text-align: justify;">Llevamos a cabo cálculo de consumo y rendimiento de Diesel de su empresa, elaboramos un análisis de rendimiento de sus flotillas para hacerles una propuesta de entrega de combustible de acuerdo a sus unidades y un precio competitivo que beneficie en el rendimiento de inversión, mejorando sus costos siempre por debajo de precio bomba PEMEX.</p>
              <p style="text-align: justify;">Asimismo los apoyamos a que asegure un ahorro considerable en el consumo de combustible con beneficio directo e inmediato para su empresa.</p>
            </div>
          </div>
            ...
            <div class="sidebar sidebar-left mt-sm-30 ml-30 ml-sm-0">
              <div class="widget">
                <div class="services-list">
                  <ul class="list mt-0">
                    <li><a href="s01.php">Venta de Diesel en Centro de Distribucion</a></li>
                    <li class="active"><a href="s02.php">Suministro de Diesel a Tanque de Consumo</a></li>
