    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/services/ss04.jpg">
      <div class="container pt-100 pb-50"> 
        ...
        <div class="section-content pt-100">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Crédito y Financiamiento</h3>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service"> <img src="../images/services/ssh04.jpg" alt="">
              ...
              <p style="text-align: justify;">Tenemos claro de las necesidades de las empresas de poder mantenerse en permanente operación, no detener sus rutas y crecer gradualmente en unidades.</p>
              <p style="text-align: justify;">Por lo cual, contamos con planes de financiamiento que puedan ajustarse a las necesidades de nuestros clientes.</p>
            </div>
          </div>
              ...
              <div class="widget">
                <div class="services-list">
                  <ul class="list mt-0">
                    ...
                    <li class="active"><a href="s04.php">Credito y Financiamiento</a></li>
                    <li><a href="s05.php">Software de Control de Flotillas</a></li>
                    <li><a href="s06.php">Mantenimiento y Laboratorio Móvil</a></li>
                  </ul>
                </div>
