    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/services/ss05.jpg">
      <div class="container pt-100 pb-50"> 
        ...
        <div class="section-content pt-100">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Software de control de flotillas</h3>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service"> <img src="../images/services/ssh05.jpg" alt="">
              ...
              <p style="text-align: justify;">Dependiendo de las necesidades de nuestros clientes para mantener óptimo control de abasto, así le permita ser autónomo y auto regulable. Ofrecemos programas en los equipos dispensadores de combustible.</p>
              <p style="text-align: justify;">De esta manera, nuestros clientes podrán controlar el consumo diario y rendimiento de sus flotillas.</p>
            </div>
          </div>
              ...
              <div class="widget">
                <div class="services-list">
                  <ul class="list mt-0">
                    ...
                    <li class="active"><a href="s05.php">Software de Control de Flotillas</a></li>
                    <li><a href="s06.php">Mantenimiento y Laboratorio Móvil</a></li>
                  </ul>
                </div>
              </div>
