    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/services/ss06.jpg">
      <div class="container pt-100 pb-50"> 
        ...
        <div class="section-content pt-100">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Mantenimiento y Laboratorio Móvil</h3>
              ...
              <div class="widget">
                <div class="services-list">
                  <ul class="list mt-0">
                    ...
                    <li><a href="s05.php">Software de Control de Flotillas</a></li>
                    <li class="active"><a href="s06.php">Mantenimiento y Laboratorio Móvil</a></li>
                  </ul>
                </div>
              </div>
            </div>
