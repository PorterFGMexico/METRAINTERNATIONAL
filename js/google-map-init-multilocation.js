function initialize() {
    ...
    // Multiple Markers
    var markers = [
        ['Corporativo Manzanillo', 19.113706,-104.322281],
        ['Puerto de Manzanillo', 19.076214,-104.288473],
        ['Almacenes Especializados', 19.0787706,-104.275593]
    ];
                        
    // Info Window Content
    var infoWindowContent = [
        ['<div class="info_content">' +
        '<h3>Oficinas Corporativas y Administrativas</h3>' +
        '' +        '</div>'],
        ['<div class="info_content">' +
        '<h3>Puerto/Punto de descarga de Hidrocarburos</h3>' +
        '' +
        '</div>'],
        ['<div class="info_content">' +
        '<h3>Instalaciones Operativas y estación de servicio de abasto de combustibles</h3>' +
        '' +
        '</div>']
    ];
