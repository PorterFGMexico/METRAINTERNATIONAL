    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="../images/services/ss07.jpg">
      <div class="container pt-100 pb-50">
        ...
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-theme-colored">Almacenaje y Maniobras de Minerales y Concentrados</h3>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <p style="text-align: justify;">Nuestros almacenes cuentan con sistemas de video vigilancia las 24 horas, bardas perimetrales y las mejores medidas de seguridad para su mercancía.</p>
              <p style="text-align: justify;">Ofrecemos con seguridad el mejor tratamiento de los materiales para maniobras de homogeneizado, humectación, cribado, planchado, separación, ensacado y carga a contenedores a granel o super sacos.</p>
            </div>
          </div>
            ...
            <div class="sidebar sidebar-left mt-sm-30 ml-30 ml-sm-0">
              <div class="widget">
                <div class="services-list">
                  <ul class="list mt-0">
                    <li ><a href="../m/s01.php">Comercialización de Minerales y Concentrados</a></li>
                <li class="active"><a href="../m/s02.php">Almacenaje y Maniobras de Minerales y Concentrados</a></li>
                <li><a href="../m/s03.php">Maniobras y Exportación de Sal</a></li>
                <li><a href="../m/s04.php">Asesoría y Gestoría en Logística Portuaria Minera</a></li>
                <li><a href="../m/s05.php">Consultoría para Desarrollo de Proyectos en Lotes Mineros</a></li>
                <li><a href="../m/s06.php">Asesoría y Gestoría para Trámites de Permisos y Autorizaciones.</a></li>
